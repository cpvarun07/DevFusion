-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'WORKSPACE_OWNER', 'PROJECT_MANAGER', 'TEAM_MEMBER', 'CLIENT');

-- CreateEnum
CREATE TYPE "Priority" AS ENUM ('LOW', 'MEDIUM', 'HIGH', 'URGENT');

-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('BACKLOG', 'TODO', 'IN_PROGRESS', 'CODE_REVIEW', 'TESTING', 'COMPLETED');
...
CREATE TABLE "WorkspaceSetting" (
    ...
    "workspaceId" TEXT NOT NULL,
    "customColumns" JSONB,
    "allowedFileTypes" TEXT[] DEFAULT ARRAY['png', 'jpg', 'pdf', 'zip', 'mp4']::TEXT[],
